...
namespace Tentacle
{
	...
	// non-nullable types
	static_assert(std::is_same_v<TBindingInstRef<USimpleUService>, USimpleUService&>, "UObjects should be referenced as reference");
	static_assert(std::is_same_v<TBindingInstRef<USimpleInterfaceImplementation>, USimpleInterfaceImplementation&>, "UObjects that implement an UInterface should be referenced as references");
	...
	// nullable types
	static_assert(std::is_same_v<TBindingInstOpt<USimpleUService>, TObjectPtr<USimpleUService>>, "UObjects should be optionally passed as TObjectPtr");
	static_assert(std::is_same_v<TBindingInstOpt<USimpleInterfaceImplementation>, TObjectPtr<USimpleInterfaceImplementation>>, "UObjects that implement an UInterface should be optionally passed as TObjectPtr");
	static_assert(std::is_same_v<TBindingInstOpt<ISimpleInterface>, TScriptInterface<ISimpleInterface>>, "Interfaces should be optionally passed as TScriptInterface");
	static_assert(std::is_same_v<TBindingInstOpt<FSimpleUStructService>, TOptional<FSimpleUStructService>>, "UStructs should be optionally passed as TOptional");
	static_assert(std::is_same_v<TBindingInstOpt<FSimpleNativeService>, TSharedPtr<FSimpleNativeService>>, "Native Types should be optionally passed as SharedPtr");
	...
	// nullable types
	static_assert(std::is_same_v<TBindingInstOptBaseType<TObjectPtr<USimpleUService>>::Type, USimpleUService>, "UObjects should be optionally passed as TObjectPtr");
	static_assert(std::is_same_v<TBindingInstOptBaseType<TObjectPtr<USimpleInterfaceImplementation>>::Type, USimpleInterfaceImplementation>, "UObjects that implement an UInterface should be optionally passed as TObjectPtr");
	static_assert(std::is_same_v<TBindingInstOptBaseType<TScriptInterface<ISimpleInterface>>::Type, ISimpleInterface>, "Interfaces should be optionally passed as TScriptInterface");
	static_assert(std::is_same_v<TBindingInstOptBaseType<TOptional<FSimpleUStructService>>::Type, FSimpleUStructService>, "UStructs should be optionally passed as TOptional");
	static_assert(std::is_same_v<TBindingInstOptBaseType<TSharedPtr<FSimpleNativeService>>::Type, FSimpleNativeService>, "Native Types should be optionally passed as SharedPtr");
